...
class CounterModel(models.Model):
    icon1 = models.FileField(upload_to='tda_counter_icons/', null=True, blank=True)
    icon1_text = models.CharField(max_length=255)
    icon1_des = models.CharField(max_length=255)
    icon2 = models.FileField(upload_to='tda_counter_icons/', null=True, blank=True)
    icon2_text = models.CharField(max_length=255)
    icon2_des = models.CharField(max_length=255)
    icon3 = models.FileField(upload_to='tda_counter_icons/', null=True, blank=True)
    icon3_text = models.CharField(max_length=255)
    icon3_des = models.CharField(max_length=255)
    icon4 = models.FileField(upload_to='tda_counter_icons/', null=True, blank=True)
    icon4_text = models.CharField(max_length=255)
    icon4_des = models.CharField(max_length=255)
    image = models.ImageField(upload_to='tda_counter_images/', null=True, blank=True)
